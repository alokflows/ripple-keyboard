...
import dev.patrickgold.florisboard.ripple.RippleManager
...
class FlorisApplication : Application() {
    ...
    val rippleManager = lazy { RippleManager(this) }
...
fun Context.rippleManager() = this.florisApplication().rippleManager
