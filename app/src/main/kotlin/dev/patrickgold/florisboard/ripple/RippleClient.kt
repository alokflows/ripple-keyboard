...
/**
 * The single networking surface for the Ripple keyboard — one OkHttp WebSocket
 * speaking the relay protocol (see the product repo's HANDOFF §4). Owned by
 * [RippleRepository] so the app UI and the IME share one live socket.
 *
